...
model_path = 'Models/fetal-health-models.pkl'
...
def liverprediction(final_features):
    ...
    model_paths = 'Models/liver-disease_model.pkl'
    model = pickle.load(open(model_paths, 'rb'))
    ...
    if request.method == 'POST':
        try:
            if 'image' in request.files:
                ...
                model_pathss = "Models/malaria-model.h5"
                model = tf.keras.models.load_model(model_pathss)
